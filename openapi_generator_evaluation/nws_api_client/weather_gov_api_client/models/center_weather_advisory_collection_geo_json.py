...
T = TypeVar("T", bound="CenterWeatherAdvisoryCollectionGeoJson")


@_attrs_define
class CenterWeatherAdvisoryCollectionGeoJson:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        center_weather_advisory_collection_geo_json = cls(
            type_=type_,
            features=features,
            context=context,
        )

        center_weather_advisory_collection_geo_json.additional_properties = d
        return center_weather_advisory_collection_geo_json
