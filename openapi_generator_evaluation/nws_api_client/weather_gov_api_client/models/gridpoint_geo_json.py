...
T = TypeVar("T", bound="GridpointGeoJson")


@_attrs_define
class GridpointGeoJson:
    """
    Attributes:
        ...
        properties (GeoJsonFeatureProperties): Raw forecast data for a 2.5km grid square.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gridpoint_geo_json.additional_properties = d
        return gridpoint_geo_json
