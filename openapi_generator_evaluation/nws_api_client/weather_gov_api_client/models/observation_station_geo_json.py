...
T = TypeVar("T", bound="ObservationStationGeoJson")


@_attrs_define
class ObservationStationGeoJson:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        observation_station_geo_json = cls(
            type_=type_,
            geometry=geometry,
            properties=properties,
            context=context,
        ...
        observation_station_geo_json.additional_properties = d
        return observation_station_geo_json
