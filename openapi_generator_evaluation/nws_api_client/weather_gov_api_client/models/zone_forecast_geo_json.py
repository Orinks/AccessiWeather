...
T = TypeVar("T", bound="ZoneForecastGeoJson")
...
class ZoneForecastGeoJson:
    ...
    Attributes:
        ...
        properties (GeoJsonFeatureProperties): An object representing a zone area forecast.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        zone_forecast_geo_json.additional_properties = d
        return zone_forecast_geo_json
