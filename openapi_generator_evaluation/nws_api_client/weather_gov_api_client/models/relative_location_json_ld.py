...
T = TypeVar("T", bound="RelativeLocationJsonLd")


@_attrs_define
class RelativeLocationJsonLd:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        relative_location_json_ld.additional_properties = d
        return relative_location_json_ld
