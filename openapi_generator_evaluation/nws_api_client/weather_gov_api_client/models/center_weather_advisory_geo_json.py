...
T = TypeVar("T", bound="CenterWeatherAdvisoryGeoJson")


@_attrs_define
class CenterWeatherAdvisoryGeoJson:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        center_weather_advisory_geo_json = cls(
            type_=type_,
            geometry=geometry,
            properties=properties,
            context=context,
        ...
        center_weather_advisory_geo_json.additional_properties = d
        return center_weather_advisory_geo_json
