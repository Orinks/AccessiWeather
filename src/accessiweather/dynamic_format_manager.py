...
class DynamicFormatManager:
    ...
    DEFAULT_TEMPLATES = {
        "default": "{temp}°F {condition}",
        "alert": "{event}: {severity}",
        "severe_weather": "⚠️ {condition} {temp}°F",
        "temperature_extreme": "🌡️ {temp}°F {condition}",
        "wind_warning": "💨 {wind_dir} {wind_speed} {condition}",
        "precipitation": "🌧️ {condition} {temp}°F",
        "fog": "🌫️ {condition} {temp}°F",
