...
class LocationManager:
    ...
    def _parse_geocoding_result(self, data: dict) -> Optional[Location]:
    ...
    def get_us_state_from_coordinates(self, latitude: float, longitude: float) -> Optional[str]:
    ...
    async def get_current_location_from_ip(self) -> Optional[Location]:
