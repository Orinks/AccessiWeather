...
def _serialize_environmental(env: EnvironmentalConditions | None) -> dict | None:
    ...
    return {
        ...
        "air_quality_updated_at": _serialize_datetime(env.air_quality_updated_at),
        "air_quality_reporting_area": env.air_quality_reporting_area,
        "air_quality_source": env.air_quality_source,
...
def _deserialize_environmental(data: dict | None) -> EnvironmentalConditions | None:
    ...
    env = EnvironmentalConditions(
        ...
        air_quality_updated_at=_deserialize_datetime(data.get("air_quality_updated_at")),
        air_quality_reporting_area=data.get("air_quality_reporting_area"),
        air_quality_source=data.get("air_quality_source"),
