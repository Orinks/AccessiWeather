...
class NwsAlertsDiscussions:
    ...
    def get_alerts(
        ...
        try:
            ...
            if precise_location and location_type in ("county", "forecast", "fire") and location_id:
                ...
                cache_key = self.wrapper._generate_cache_key("alerts_zone", {"zone_id": location_id})
                ...
                def fetch_data() -> Dict[str, Any]:
                    ...
                    try:
                        ...
                        url = f"{self.wrapper.core_client.BASE_URL}/alerts/active/zone/{location_id}"
            ...
            if not precise_location and location_type == "state" and location_id:
                ...
                def fetch_data() -> Dict[str, Any]:
                    self.wrapper._rate_limit()
                    try:
                        url = f"{self.wrapper.core_client.BASE_URL}/alerts/active?area={location_id}"
    ...
    def get_discussion(self, lat: float, lon: float, force_refresh: bool = False) -> Optional[str]:
        ...
        try:
            ...
            office_id = parts[-3]
            cache_key = self.wrapper._generate_cache_key(f"products/types/AFD/locations/{office_id}", {})
            ...
            def fetch_data() -> Optional[str]:
                ...
                try:
                    ...
                    product_url = f"{self.wrapper.core_client.BASE_URL}/products/{latest_product_id}"
            ...
            return cast(
                Optional[str], self.wrapper._get_cached_or_fetch(cache_key, fetch_data, force_refresh)
            )
        except Exception as e:
    ...
    def get_national_product(
        ...
        try:
            ...
            def fetch_data() -> Optional[str]:
                ...
                try:
                    products_url = (
                        f"{self.wrapper.core_client.BASE_URL}/products/types/{product_type}/locations/{location}"
                    )
                    products_response = self.wrapper._fetch_url(products_url)
