...
_PRODUCT_PRESETS: dict[str, str] = {
    ...
    "WPC Medium Range Discussion (Weather Prediction Center)": "PMDEPD",
    "WPC Extended Discussion (Weather Prediction Center)": "PMDET4",
    ...
    "NHC Atlantic Tropical Weather Outlook (National Hurricane Center)": "TWOAT",
    "NHC East Pacific Tropical Weather Outlook (National Hurricane Center)": "TWOEP",
