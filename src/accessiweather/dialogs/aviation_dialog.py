...
class AviationDialog:
    ...
    def _build_ui(self) -> None:
        ...
        header = toga.Label(
            ...
            style=Pack(font_size=13, font_style="italic", margin_bottom=10),
        )
        main_box.add(header)
        ...
        input_row.add(toga.Label("Airport code:", style=Pack(font_weight="bold", margin_right=10)))
        ...
        self.status_label = toga.Label(
            ...
            style=Pack(font_size=12, font_style="italic", color="#555555", margin_bottom=10),
        )
        main_box.add(self.status_label)

        content_row = toga.Box(style=Pack(direction=ROW, flex=1, margin_bottom=10))

        raw_box = toga.Box(style=Pack(direction=COLUMN, flex=1, margin_right=12))
