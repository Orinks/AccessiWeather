...
This module contains fallback logic for switching between weather APIs
when the primary API fails.
"""
...
class WeatherServiceFallback:
    """Handles fallback logic between weather APIs."""
    ...
    def __init__(
        ...
        config_helper: WeatherServiceConfig,
    ):
        ...
        Args:
            ...
            config_helper: Configuration helper instance
        """
    ...
    def try_fallback_api(
        ...
        try:
            ...
            if self.config_helper.should_use_openmeteo(lat, lon):
                if self.config_helper.is_location_in_us(lat, lon):
