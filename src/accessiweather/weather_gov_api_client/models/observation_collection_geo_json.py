...
T = TypeVar("T", bound="ObservationCollectionGeoJson")


@_attrs_define
class ObservationCollectionGeoJson:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        observation_collection_geo_json = cls(
            type_=type_,
            features=features,
            context=context,
        )

        observation_collection_geo_json.additional_properties = d
        return observation_collection_geo_json
