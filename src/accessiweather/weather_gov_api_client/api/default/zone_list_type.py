...
def _get_kwargs(
    ...
    *,
    ...
    type_query: Union[Unset, list[NWSZoneType]] = UNSET,
    ...
    json_type_query: Union[Unset, list[str]] = UNSET
    if not isinstance(type_query, Unset):
        json_type_query = []
        for type_item_data in type_query:
            type_item = type_item_data.value
            json_type_query.append(type_item)

    params["type"] = json_type_query
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        type_query (Union[Unset, list[NWSZoneType]]):
