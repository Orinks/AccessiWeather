...
class AIExplainerPromptMixin:
    ...
    def get_default_system_prompt() -> str:
        ...
        """
        return (
            "You are a helpful weather assistant that explains weather information "
            ...
            "Use only the information provided in the request. Do not invent missing details, "
            "hazards, records, dates, locations, or forecast impacts. If something is unclear "
            "or not provided, say so plainly.\n\n"
            "Avoid visual-only descriptions. When useful, explain what the weather information "
            "means for comfort, travel, planning, or safety, but only when supported by the "
            "provided text or data.\n\n"
            "IMPORTANT: Do NOT repeat the location name, date, time, or timezone in your "
            "response unless it is necessary for clarity. The user already sees this "
            "information. Jump straight into the explanation.\n\n"
    ...
    def _build_prompt(
        ...
        if forecast_periods:
            ...
            for period in forecast_periods:
                ...
                period_text += period.get("temperature_text") or (
