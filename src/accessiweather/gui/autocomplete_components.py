...
This module provides autocomplete-related accessible UI widgets that enhance screen reader support.
"""
...
class WeatherTextCompleter(wx.TextCompleterSimple):
    ...
    def GetCompletions(self, prefix):
        ...
        return [
            comp for comp in self.completions if comp.lower().startswith(prefix_lower)
        ]
