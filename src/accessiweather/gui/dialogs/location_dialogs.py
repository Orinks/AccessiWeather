"""Location dialog components for AccessiWeather

This module provides dialog windows for location-related user interactions,
including manual coordinate entry and location search with geocoding.
