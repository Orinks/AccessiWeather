...
class SearchResultHandler:
    ...
    def format_no_results_message(query: str, geocoding_service: GeocodingService) -> str:
        ...
        elif geocoding_service.data_source == "nws":
            return f"No results found for '{query}' or location is outside the US NWS coverage area."
        else:
...
class LocationSearchResultProcessor:
    ...
    def process_search_result(
        self, result: Optional[Tuple[float, float, str]], query: str
