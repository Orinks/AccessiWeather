...
### Added
- GPG signature verification for update downloads - the update system now verifies digital signatures on downloaded updates to ensure they come from a trusted source, providing stronger security against tampering or man-in-the-middle attacks. Signature verification runs automatically after checksum validation
