...
async def test_parallel_nws_fetching_faster_than_sequential():
    ...
    with patch('accessiweather.weather_client_nws.get_nws_current_conditions', new=mock_current):
        with patch('accessiweather.weather_client_nws.get_nws_forecast_and_discussion', new=mock_forecast):
            with patch('accessiweather.weather_client_nws.get_nws_alerts', new=mock_alerts):
                with patch('accessiweather.weather_client_nws.get_nws_hourly_forecast', new=mock_hourly):
