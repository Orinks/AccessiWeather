...
class TestLocationChange(unittest.TestCase):
    ...
    def setUp(self):
        self.app = wx.App()
        # Set testing flag for wxPython to avoid segfaults in CI
        wx.testing = True
        ...
        ny_name = "New York"
        self.location_manager_mock.get_current_location_name.return_value = ny_name
        self.location_manager_mock.get_current_location.return_value = (ny_name, 40.7128, -74.0060)
        ...
        # Helper to immediately execute CallAfter functions during tests
        def immediate_call_after(func, *args, **kwargs):
            func(*args, **kwargs)
    ...
    def test_location_change_updates_forecast(self):
        ...
        # Patch the forecast and alerts fetchers
        # to directly call the success callbacks
