...
class TestLocationService:
    ...
    def test_get_current_location(self, location_service, mock_location_manager):
        ...
        # Set up mock return value using patch.object
        expected_location = ("Test City", 35.0, -80.0)
        with patch.object(mock_location_manager, 'get_current_location', return_value=expected_location):
            # Call the method
    ...
    def test_get_current_location_name(self, location_service, mock_location_manager):
        ...
        with patch.object(mock_location_manager, 'get_current_location_name', return_value=expected_name):
            # Call the method
    ...
    def test_get_all_locations(self, location_service, mock_location_manager):
        ...
        with patch.object(mock_location_manager, 'get_all_locations', return_value=expected_locations):
            # Call the method
    ...
    def test_add_location(self, location_service, mock_location_manager):
        ...
        # Use patch.object for the method
        with patch.object(mock_location_manager, 'add_location') as mock_add:
            # Call the method
            location_service.add_location("New City", 40.0, -75.0)

            # Verify the method was called with the correct arguments
            mock_add.assert_called_once_with("New City", 40.0, -75.0)

    def test_remove_location(self, location_service, mock_location_manager):
        """Test removing a location."""
        # Use patch.object for the method
        with patch.object(mock_location_manager, 'remove_location') as mock_remove:
            # Call the method
            location_service.remove_location("Test City")

            # Verify the method was called with the correct arguments
            mock_remove.assert_called_once_with("Test City")

    def test_set_current_location(self, location_service, mock_location_manager):
        """Test setting the current location."""
        # Use patch.object for the method
        with patch.object(mock_location_manager, 'set_current_location') as mock_set:
            # Call the method
            location_service.set_current_location("Test City")

            # Verify the method was called with the correct arguments
            mock_set.assert_called_once_with("Test City")
    ...
    def test_get_location_coordinates(self, location_service, mock_location_manager):
        ...
        with patch.object(mock_location_manager, "saved_locations", test_locations):
            # Call the method
    ...
    def test_is_nationwide_location(self, location_service, mock_location_manager):
        ...
        # Use patch.object for the method
        with patch.object(mock_location_manager, 'is_nationwide_location', return_value=True) as mock_check:
            # Call the method
            result = location_service.is_nationwide_location("Nationwide")

            # Verify the result
            assert result is True
            mock_check.assert_called_once_with("Nationwide")
