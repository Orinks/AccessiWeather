...
def mock_notifier():
    ...
    notifier.process_alerts.return_value = SAMPLE_ALERTS
...
def test_notify_alerts_with_alerts(notification_service, mock_notifier):
    ...
    mock_notifier.notify_alerts.assert_called_once_with(count)
...
def test_notify_alerts_with_custom_count(notification_service, mock_notifier):
    ...
    mock_notifier.notify_alerts.assert_called_once_with(custom_count)
