...
def test_onboarding_wizard_portable_happy_path_sets_keys_and_bundle(monkeypatch, tmp_path):
    ...
    # TextEntryDialog: OR key, Pirate key, bundle passphrase
    text_responses = [
        "FAKE_OR_KEY_TEST",
        "FAKE_PW_KEY_TEST",
...
def test_wizard_step2_step3_numbering_non_portable(monkeypatch):
    """Non-portable wizard passes 'of 3' to provider key prompts."""
    app = AccessiWeatherApp.__new__(AccessiWeatherApp)
    app._portable_mode = False
    app._force_wizard = False
    app._portable_keys_imported_this_session = False
...
def test_wizard_step2_step3_numbering_portable(monkeypatch):
    """Portable wizard passes 'of 4' to provider key prompts."""
    app = AccessiWeatherApp.__new__(AccessiWeatherApp)
    app._portable_mode = True
    app._force_wizard = False
    app._portable_keys_imported_this_session = False
