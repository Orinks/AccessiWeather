...
### Changed
- Settings can now automatically play a matching NOAA Weather Radio station for qualifying alerts that use Specific Area Message Encoding (SAME), then stop after the chosen duration when a reliable station match is available.
