...
- [x] 2. Modify AIExplainer to support custom prompts
  ...
  - [-] 2.2 Implement `get_effective_system_prompt()` method
  ...
  - [ ] 2.3 Write property test for custom system prompt usage
...
- [ ] 4. Add prompt customization UI to settings dialog
  ...
  - [ ] 4.2 Add reset buttons for prompts
  ...
  - [ ] 4.3 Write property test for reset behavior
    - **Property 7: Reset restores defaults**
    - **Validates: Requirements 3.1, 3.2, 3.3**
  - [ ] 4.4 Add preview button and dialog
    - "Preview Prompt" button shows preview dialog
    - Display both system and user prompts
    - _Requirements: 4.1, 4.2_
  - [ ] 4.5 Add accessibility attributes to all form elements
...
- [ ] 5. Wire up settings to AIExplainer
  - [ ] 5.1 Pass custom prompts from settings to AIExplainer
